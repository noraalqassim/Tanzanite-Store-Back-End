   ...
   // {
     //   protected readonly OrderGemstoneRepository _orderGemstoneRepo;
       ...
       // {
        ...
        //Task<OrderDTO.OrderGemstoneReadDto> IOrderGemstoneService.CreateOnAsync(OrderGemstoneCreateDto createDto)
        //{
         //   throw new NotImplementedException();
        //}

        //Task<List<OrderDTO.OrderGemstoneReadDto>> IOrderGemstoneService.GetAllAsync()
        //{
         //   throw new NotImplementedException();
        //}

        //Task<OrderDTO.OrderGemstoneReadDto> IOrderGemstoneService.GetByIdAsync(Guid orderGemstoneId)
        //{
          //  throw new NotImplementedException();
        //}
    //}
